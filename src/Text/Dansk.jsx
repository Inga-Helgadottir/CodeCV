...
export const AboutMeHeadingAndParagraph_dk = {
  ...
  paragraphs: [
    ...
    "Udenover kodning kan jeg lide at male, bage og at spille bræt-, kort- og computerspil. Jeg kan også lide at tage billeder, her er nogle af mine billeder som jeg tog under en skole tur til Jordan",
  ],
};
